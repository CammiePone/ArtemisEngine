...
import com.artemisgamesstudio.engine.core.model.Material;
import com.artemisgamesstudio.engine.core.model.Mesh;
import com.artemisgamesstudio.engine.core.model.Model;
import com.artemisgamesstudio.engine.core.model.Vertex;
import com.artemisgamesstudio.engine.core.texturing.Texture2D;
import com.artemisgamesstudio.engine.core.utils.Util;
		...
		long time = System.currentTimeMillis();
			...
			try
			{
				...
				while((line = meshReader.readLine()) != null)
				{
					...
					{
						texCoords.add(new Vec2F(Float.valueOf(tokens[1]),
								Float.valueOf(tokens[2])));
					}
